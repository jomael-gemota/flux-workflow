...
export function Layout({ canvas, configPanel, fluxellePanel }: LayoutProps) {
  const { configOpen, isSwitchingWorkflow, rightPanelTab, setRightPanelTab } = useWorkflowStore();
